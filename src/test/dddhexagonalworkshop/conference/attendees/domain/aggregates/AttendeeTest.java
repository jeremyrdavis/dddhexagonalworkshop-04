package test.dddhexagonalworkshop.conference.attendees.domain.aggregates;
 ...
 * These tests cover the registration of an attendee, retrieval of full name, address, and email,
 * and verification of the attendee registered event.
 */
